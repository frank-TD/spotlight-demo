          ...
          <div className="bg-white border border-border rounded-xl p-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <Textarea className="mt-1.5 resize-none text-sm" rows={3} defaultValue={activeRole === "creator" ? "Award-winning AIGC filmmaker. Previously: Sundance Lab, NVIDIA AI Lab." : "Creative director and founder of NeoVision. Obsessed with where AI meets storytelling."} />
              </div>
          ...
          <div className="bg-white border border-border rounded-xl p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-0.5">Required for withdrawals</p>
              </div>
