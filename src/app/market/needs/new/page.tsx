        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="bg-surface-container-lowest border border-outline-variant/30 rounded-2xl p-7 space-y-5">
            ...
            <div>
              ...
              <input className={inputCls} placeholder={t.postNeed.projectTitlePlaceholder} defaultValue="" />
            </div>
            <div>
            ...
            <div>
              ...
              <textarea rows={4} className={cn(inputCls, "resize-none")} placeholder={t.postNeed.projectBriefPlaceholder} />
            </div>
          </div>
          ...
          <div className="bg-surface-container-lowest border border-outline-variant/30 rounded-2xl p-7 space-y-5">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input className={inputCls} type="number" defaultValue="4500" />
              </div>
              <div>
                <label className={labelCls}>{t.postNeed.deliveryDays}</label>
                <input className={inputCls} type="number" defaultValue="21" />
              </div>
            </div>
            <div>
