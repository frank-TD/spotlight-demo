...
const STUDIOS = [
  { name: "Pegasus", style: "tracking-[0.25em] text-on-surface-variant/70" },
  { name: "Dramawave", style: "tracking-[0.18em] text-on-surface-variant/70 italic" },
  { name: "Mandarin", style: "tracking-[0.3em] text-on-surface-variant/80 font-bold" },
  { name: "RedSky Drama", style: "tracking-[0.18em] text-on-surface-variant/70" },
  { name: "NeoFrame", style: "tracking-[0.22em] text-on-surface-variant/70" },
];
...
export default function TrustLogosSection() {
  ...
  return (
    <section className="py-14 md:py-16 border-y border-outline-variant/30">
      <p className="font-label text-[10px] uppercase tracking-[0.3em] text-on-surface-variant text-center mb-10">
