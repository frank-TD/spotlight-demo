...
const en = {
  ...
  chat: {
    ...
    invitationCard: (name: string) => `${name} sent a collaboration invitation. Awaiting response.`,
...
const zhCN: typeof en = {
  ...
  chat: {
    ...
    invitationCard: (name: string) => `${name} 已向对方发起合作邀约，等待回复。`,
...
const zhTW: typeof en = {
  ...
  chat: {
    ...
    invitationCard: (name: string) => `${name} 已向對方發起合作邀約，等待回覆。`,
