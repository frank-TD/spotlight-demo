...
const en = {
  ...
  onboarding: {
    roleTitle: "How will you join Spotlight?",
    roleSubtitle: "Pick the seat you'll start from. You can switch anytime from the account menu.",
    backerTitle: "I'm a Backer",
    backerDesc: "Commission stories. Brief the creators you love. Run productions end-to-end with escrowed milestones.",
    backerCta: "Continue as Backer",
    creatorTitle: "I'm a Creator",
    ...
    profileBackerSubtitle: "Helps us match you with the right creators. You can refine anything later.",
    profileCreatorTitle: "Tell us about your craft",
    profileCreatorSubtitle: "Helps backers find and brief you. You can refine anything later.",
    required: "Required",
    optional: "Optional",
...
const zhCN: typeof en = {
  ...
  onboarding: {
    roleTitle: "你想以何种身份加入 Spotlight？",
    roleSubtitle: "选个起点。你随时可以从账户菜单切换身份。",
    backerTitle: "我是 Backer",
    backerDesc: "委托故事，发布需求，全流程托管制片，按阶段释放定金。",
    backerCta: "以 Backer 身份继续",
    creatorTitle: "我是 Creator",
    ...
    profileBackerSubtitle: "帮我们为你匹配合适的创作者。所有内容稍后可改。",
    profileCreatorTitle: "聊聊你的专长",
    profileCreatorSubtitle: "让 Backer 更容易找到你。所有内容稍后可改。",
    required: "必填",
    optional: "选填",
    skipForNow: "暂时跳过",
    finish: "完成设置",
...
const zhTW: typeof en = {
  ...
  onboarding: {
    roleTitle: "你想以何種身分加入 Spotlight？",
    roleSubtitle: "選個起點。你隨時可以從帳戶選單切換身分。",
    backerTitle: "我是 Backer",
    backerDesc: "委託故事，發佈需求，全流程託管製片，按階段釋放訂金。",
    backerCta: "以 Backer 身分繼續",
    creatorTitle: "我是 Creator",
    ...
    creatorCta: "以 Creator 身分繼續",
    profileBackerTitle: "聊聊你的品牌",
    profileBackerSubtitle: "幫我們為你匹配合適的創作者。所有內容稍後可改。",
    profileCreatorTitle: "聊聊你的專長",
    profileCreatorSubtitle: "讓 Backer 更容易找到你。所有內容稍後可改。",
    required: "必填",
    optional: "選填",
    skipForNow: "暫時略過",
    finish: "完成設定",
