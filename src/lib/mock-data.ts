...
// Hero background pool — cross-fade reel; the two newest clips (hero-0, hero-0b)
// play first, then the three earlier films cycle after them.
const HERO_CLIP_IDS = ["hero-0", "hero-0b", "hero-1", "hero-2", "hero-3"];
